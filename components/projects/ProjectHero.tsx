...
export function ProjectHero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="section-reveal relative overflow-hidden rounded-4xl border border-(--border-subtle) bg-(--surface-panel) p-10 text-(--text-primary) shadow-[0_40px_160px_-90px_var(--shadow-soft)] sm:p-12"
    >
